...
import { jobsGalleryType } from "@/type";
...
const GallerySlider = ({ jobsGallery }: GallerySliderProps) => {  
    
    const slider = React.useRef<null | any>();

    console.log(jobsGallery)
